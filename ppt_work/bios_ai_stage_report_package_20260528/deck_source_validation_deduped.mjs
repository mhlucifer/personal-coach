...
function createSmbiosValidationFlowSlide(presentation, page) {
  const slide = slideBase(presentation);
  header(slide, "03 / VALIDATION", "SMBIOS 验证从“人工多环境切换”沉淀为基于 opencode skills 的可追踪自动化流程", page);
...
export async function createSlide(presentation, ctx, number) {
  ...
  if (number === 9) {
    return createSmbiosValidationFlowSlide(presentation, 9);
  }

  if (number === 10) {
    return createSmbiosVerifySlide(presentation, 10);
  }

  if (number === 11) {
    return createTypeRefactorSlide(presentation, 11);
  }
